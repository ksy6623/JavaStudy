...
public class CollectionList {
	...
	/*
	 * 컬렉션 프레임워크는 데이터를 보다 쉽게 다룰 수 있도록 재사용 가능한 클렉션 클래스를 제공함.
	 * List, Set, Map
	...
	System.out.println(students.isEmpty()); //리스트가 비어있는 지 (true/false)
	...
	// <> <-- 아 뷰뷴운 제네릭(Generic)이라고하며 코드에서 타입의 안정성을 보장할 수 있으며
