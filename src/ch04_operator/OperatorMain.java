...
public class OperatorMain {
	...
	public static void main(String[] args) {
		...
		System.out.println("아이디어를 입력해주세요(4자리 이상)");
		System.out.print(">>>");
		Scanner scan = new Scanner(System.in);
		// 사용자 입력을 받아서 조건이 맞으면 (사용가능합니다.)
		// 		 맞지않으면 (4자리 이상으로 다시 입력하세요.) 출력
		String userInput = scan.nextLine();
		int len = userInput.length(); //문자열 길이
		System.out.println("문자열 길이 : " +len);
		String output = len >= 4 ? "사용 가능합니다." : "4자리 이상으로 다시 입력!";
		System.out.println(output);
		
		
		//6. 논리 연산자 &&(and 연산) 둘다 true 일때 true
		//			  ||(or 연산) 둘중 1개만 ture 이면 true
		
		// 아이디를 (8 ~ 14)길이만 사용가능
		System.out.println("=== 논리 연산 ===");
		System.out.println("아이디를 입력하세요(8 ~ 14글자)");
		System.out.print(">>>");
		...
		// 3.조건식 ex) a ? b : (aa ? bb : cc) 삼항연산자 안에 삼항 연산자 들어갈 수 있음.
